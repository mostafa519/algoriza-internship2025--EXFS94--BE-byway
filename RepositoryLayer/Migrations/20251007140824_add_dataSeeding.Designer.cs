...
namespace ByWay.RepositoryLayer.Migrations
{
    ...
    [Migration("20251007140824_add_dataSeeding")]
    partial class add_dataSeeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ByWay.DomainLayer.Enrollment.CourseStudent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EnrollmentDate = new DateTime(2025, 10, 7, 17, 8, 22, 537, DateTimeKind.Local).AddTicks(578),
                            Id = 0
                        },
                        new
                        {
                            ...
                            EnrollmentDate = new DateTime(2025, 10, 7, 17, 8, 22, 542, DateTimeKind.Local).AddTicks(4276),
                            Id = 0
                        });
                });
            ...
            modelBuilder.Entity("ByWay.DomainLayer.Model.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ImageFile = "https://img.freepik.com/premium-vector/man-sits-desk-reading-book_704913-28714.jpg",
                            InstructorId = 2,
                            LectureCount = 12,
                            Level = "Intermediate",
                            Name = "UI/UX Design",
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            Description = "Become a full-stack developer using modern technologies.",
                            DurationInHours = 40,
                        ...
                        new
                        {
                            ...
                            Description = "Design stunning and user-friendly interfaces.",
                            DurationInHours = 15,
                            EndDate = new DateTime(2025, 7, 16, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ImageFile = "https://img.freepik.com/premium-vector/man-sits-desk-reading-book_704913-28714.jpg",
                            InstructorId = 3,
                            LectureCount = 12,
                            Level = "Intermediate",
                        ...
                        new
                        {
                            Id = 9,
                            CategoryId = 1,
                            Description = "Get started with Angular and build single-page applications.",
                            DurationInHours = 18,
                            EndDate = new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ImageFile = "https://img.freepik.com/premium-vector/man-sits-desk-reading-book_704913-28714.jpg",
                            InstructorId = 2,
                        ...
                        new
                        {
                            Id = 11,
                            CategoryId = 3,
                            Description = "Learn Python and use it for data analysis and visualization.",
                            DurationInHours = 30,
                        ...
                        new
                        {
                            Id = 12,
                            CategoryId = 2,
                            Description = "Master modern CSS and Tailwind for responsive design.",
                            DurationInHours = 12,
                        ...
                        new
                        {
                            Id = 13,
                            CategoryId = 1,
                            Description = "Learn Vue.js from scratch and build interactive web apps.",
                            DurationInHours = 20,
                            EndDate = new DateTime(2025, 10, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ImageFile = "https://img.freepik.com/premium-vector/man-sits-desk-reading-book_704913-28714.jpg",
                            InstructorId = 4,
                            LectureCount = 15,
                            Level = "Beginner",
                        ...
                        new
                        {
                            Id = 15,
                            CategoryId = 2,
                            Description = "Learn professional photo editing and manipulation in Photoshop.",
                            DurationInHours = 18,
            ...
            modelBuilder.Entity("ByWay.DomainLayer.Model.Instructor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Specialist in React and modern JavaScript frameworks.",
                            ImageFile = "https://tse4.mm.bing.net/th/id/OIP.nkt3lTa7B747RqrCP8mdQAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3",
                        ...
                        {
                            Id = 4,
                            Description = "Designs stunning and user-friendly interfaces.",
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-cartoon-illustration-with-sign_1120558-20344.jpg?w=2000",
                        ...
                        {
                            Id = 5,
                            Description = "Specialist in Python, Machine Learning, and AI.",
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-cartoon-illustration-with-sign_1120558-20344.jpg?w=2000",
                        ...
                        {
                            Id = 6,
                            Description = "Expert in CI/CD, Docker, and Kubernetes.",
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-cartoon-illustration-with-sign_1120558-20344.jpg?w=2000",
                        ...
                        {
                            Id = 7,
                            Description = "Builds iOS and Android apps with Flutter and React Native.",
                            ImageFile = "https://s3.amazonaws.com/coursesity-blog/2023/12/Mobile_Development_Courses.jpg",
                        ...
                        {
                            Id = 8,
                            Description = "Focuses on Python, Django, and automation.",
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-cartoon-illustration-with-sign_1120558-20344.jpg?w=2000",
                        ...
                        new
                        {
                            ...
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-presenting-lesson-front-green-chalkboard_126712-18933.jpg?w=2000",
                        ...
                        {
                            Id = 10,
                            Description = "Specialist in Java, Spring Boot, and backend architectures.",
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-presenting-lesson-front-green-chalkboard_126712-18933.jpg?w=2000",
                        ...
                        {
                            Id = 11,
                            Description = "Optimizes websites for search engines and traffic growth.",
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-presenting-lesson-front-green-chalkboard_126712-18933.jpg?w=2000",
                            JobTitle = "SEO Expert",
                            Name = "Fatma Hany",
                            Rate = 4.5
                        ...
                        {
                            Id = 12,
                            Description = "Expert in AWS, Azure, and scalable cloud solutions.",
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-presenting-lesson-front-green-chalkboard_126712-18933.jpg?w=2000",
                        ...
                        {
                            Id = 14,
                            Description = "Builds AI models and intelligent systems.",
                            ImageFile = "https://img.freepik.com/premium-vector/teacher-presenting-lesson-front-green-chalkboard_126712-18933.jpg?w=2000",
                        ...
                        {
                            Id = 15,
                            Description = "Expert in Premiere Pro, After Effects, and video production.",
                            ImageFile = "https://tse4.mm.bing.net/th/id/OIP.mCRDsfv9LcGpqRuglQ7ZxQHaFj?w=626&h=470&rs=1&pid=ImgDetMain&o=7&rm=3",
            ...
            modelBuilder.Entity("ByWay.DomainLayer.Model.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountType = 0,
                            ConcurrencyStamp = "d893a86b-0eab-45bb-bfc1-a8732f8fc35c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENd9UIeWRMqDWbg5E38kEX4AOEaeHio3bmUXju0+zHLQ1pQBv6HxXWPZy+OpmD7xog==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9d0b7563-98ce-4724-b322-aab42c34e238",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountType = 1,
                            ConcurrencyStamp = "058745ab-8f7e-4e36-ad40-147f7742bda6",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGoKcTvYdWR2963TRf8tNfuwbVFmtIYDsIRkUDEz9XhilQ2ZixUUwwcP4br1ktN6Vw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8972926a-7ea8-4b0f-a121-3fc608644200",
                            TwoFactorEnabled = false,
                            UserName = "mustafa"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountType = 1,
                            ConcurrencyStamp = "73dfe3a0-d17f-4734-add1-60d1e5e19fde",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDuGKmsHo3K3iEivt4vN03HucJYCoU9bYxY58gtKgmh2Y05NCnZ+OOQXfv8cNwwk3A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e70ca5a6-3e4c-40b7-b0a5-8eedba03c9b8",
                            TwoFactorEnabled = false,
                            UserName = "johndoe"
                        });
                });
