...
{
    /// <inheritdoc />
    public partial class updates_last_version : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3fa85f64-5717-4562-b3fc-2c963f66afa6", 0, 1, "6ba0eeaf-e6b0-4794-a2e4-e8cfb1564a1f", "mustafa.ali@example.com", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mustafa", "Ali", false, null, "MUSTAFA.ALI@EXAMPLE.COM", "MUSTAFA", "AQAAAAIAAYagAAAAEHE3KqRRcqgRj5uaWtTzi5XvgUfxJEkf557ueDIAWgUPhYFSky0jNdFiQr32Of+ufw==", null, false, "d575c514-705c-4a6c-8478-fde9d569a15f", false, "mustafa" },
                    { "4fa85f64-5717-4562-b3fc-2c963f66afa7", 0, 1, "7c02d7a1-3b78-49ef-9a13-e93fa9570afd", "john.doe@example.com", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "John", "Doe", false, null, "JOHN.DOE@EXAMPLE.COM", "JOHNDOE", "AQAAAAIAAYagAAAAEHreSNwXUd172oJsHXKD2wpHIkgXzqCsyRg09FirzZ2vfsiXSl+m7OQ+TMbHGzD6lw==", null, false, "2f385b62-b382-4b33-9f52-6be83671fc6a", false, "johndoe" },
                    { "b2c3d4e5-f6a7-8901-bcde-234567890abc", 0, 0, "a9be6b95-4415-4e0f-857f-738c18a85b34", "admin@byway.com", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "System", "Admin", false, null, "ADMIN@BYWAY.COM", "ADMIN@BYWAY.COM", "AQAAAAIAAYagAAAAEBflNhGb+rhocHTycgnULYe0b+g4s42vfCTII3qf0NAAQ6mRGinyGXOBZdULDUNDpA==", null, false, "6c8f5804-80f6-44ff-9ae5-852a512c6aaa", false, "admin@byway.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "3fa85f64-5717-4562-b3fc-2c963f66afa6", new DateTime(2025, 10, 8, 18, 4, 25, 902, DateTimeKind.Local).AddTicks(2786), 0 },
                    { 2, "4fa85f64-5717-4562-b3fc-2c963f66afa7", new DateTime(2025, 10, 8, 18, 4, 25, 904, DateTimeKind.Local).AddTicks(9980), 0 }
                });
